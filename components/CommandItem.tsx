...
export const CommandItem = (p: Props) => (
  <section className="mb-10 w-full rounded-lg">
    ...
    <div className="flex items-center gap-3">
      <div className="bg-slate-800 whitespace-nowrap overflow-x-auto overflow-y-hidden font-mono rounded-lg text-gray-100 p-2 scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-gray-300">
